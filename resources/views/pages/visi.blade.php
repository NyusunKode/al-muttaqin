...
@section('container')
    ...
    <section id="team" class="team section">
        <div class="container section-title" data-aos="fade-up">
            <span>Visi<br></span>
            <h2>Visi</h2>
            <h5>“Menyiapkan generasi Qur'ani, menyongsong masa depan gemilang”</h5>
            <p>ini tertuang dalam Ikrar Santri, yaitu:</p>
        ...
        <div class="container section-title" data-aos="fade-up">
            ...
            <p>Mengembangkan lembaga pendidikan yang berorientasi pada Al-Quran</p>
            <p>Membina ustadz dan ustadzah menjadi model pendidik yang berakhlakul karimah</p>
        </div><!-- End Section Title -->
    </section>
    <!-- About Section -->
